...
房主的功能：新建房间，解散房间（随时），切换房间类型（可以换游戏类型及PK模式，如果在pk进行时切换游戏也是可以的），重新开始pk, 离开房间，加入房间（其他人的房间或自己的房间）;房客也是同步切换的，除非是已经离开的）; 房客：加入房间，离开房间;  这些都是我想到的功能，大部分功能都已经实现了，但都有些bug, 你帮我检查下，他们都有些什么问题？你还有什么要补充的吗
